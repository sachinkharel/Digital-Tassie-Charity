...
if (isset($_POST['submit'])) {
    ...
    $category = filter_var($_POST['chairtyCat'], FILTER_SANITIZE_SPECIAL_CHARS);
    $goal = filter_var($_POST['charityGoal'], FILTER_SANITIZE_NUMBER_INT);
    $thumbnail = $_FILES['charityImg'];
    ...
    if (isset($_SESSION["add-post"])) {
        ...
        // header("location: " . ROOT_URL . 'admin/createCharity.php');
    } else {
        $insert_post = "INSERT INTO posts (name, `desc`, flyer, category, author_id, goalamt, is_featured, totaldonation) 
        VALUES (?, ?, ?, ?, ?, ?, 0,0)";
